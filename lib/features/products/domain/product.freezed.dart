...
mixin _$Product {
 ...
 int get id; String get title;@JsonKey(fromJson: _priceFromJson) double get price; String get description; String get category; String get image; Rating get rating;
...
@useResult
$Res call({
 int id, String title,@JsonKey(fromJson: _priceFromJson) double price, String description, String category, String image, Rating rating
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title, @JsonKey(fromJson: _priceFromJson)  double price,  String description,  String category,  String image,  Rating rating)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Product() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title, @JsonKey(fromJson: _priceFromJson)  double price,  String description,  String category,  String image,  Rating rating)  $default,) {final _that = this;
switch (_that) {
case _Product():
return $default(_that.id,_that.title,_that.price,_that.description,_that.category,_that.image,_that.rating);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title, @JsonKey(fromJson: _priceFromJson)  double price,  String description,  String category,  String image,  Rating rating)?  $default,) {final _that = this;
switch (_that) {
case _Product() when $default != null:
return $default(_that.id,_that.title,_that.price,_that.description,_that.category,_that.image,_that.rating);case _:
  return null;
...
class _Product implements Product {
  const _Product({required this.id, required this.title, @JsonKey(fromJson: _priceFromJson) required this.price, required this.description, required this.category, required this.image, required this.rating});
